...
RUN git clone --recursive --depth=1 https://github.com/khs1994-php/curl.git /root/khs1994-php/curl \
    && cd /root/khs1994-php/curl \
    && composer install -q \
    && composer update -q \
    && vendor/bin/phpunit
...
COPY --from=0 /root/khs1994-php/curl /root/khs1994-php/curl

RUN cd /root/khs1994-php/curl \
